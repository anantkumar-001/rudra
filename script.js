document.addEventListener('DOMContentLoaded', () => {
  ...
  const goToHero = (index) => {
    ...
    if (heroSlides[currentHero]) heroSlides[currentHero].classList.add('active');
  ...
  const goToProduct = (index) => {
    ...
    if (productSlides[currentProduct]) productSlides[currentProduct].classList.add('active');
  };
